...
public class mp_level extends AppCompatActivity
    {
        int pc_score =0;
        int player_score = 0;
        String my_c, cpu_c;
        ...
        protected void onCreate(Bundle savedInstanceState)
            {
                ...
                setContentView(R.layout.activity_mp_level);
                ...
                back.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                            {
                                click_sound.start();
                                Intent go_back = new Intent(mp_level.this,select.class);
        ...
        void calc()
            {
                ...
                {
                    iv_bg.setImageResource(R.drawable.tie_bg);
                }
                else
                {
                    if(my_c.equals("rock") && cpu_c.equals("paper"))
                    {
                        ...
                        iv_bg.setImageResource(R.drawable.lose_bg);
                    }
                    else
                    {
                        if(my_c.equals("rock") && cpu_c.equals("scissor"))
                        {
                            ...
                            iv_bg.setImageResource(R.drawable.win_bg);
                        }
                        else
                        {
